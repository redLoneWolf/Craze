...
*
*/
            CV_EXPORTS void dilate(InputArray rlSrc, OutputArray rlDest, InputArray rlKernel,
...
*/
            CV_EXPORTS void
            paint(InputOutputArray image, InputArray rlSrc, const cv::Scalar &value);
...
*/
            CV_EXPORTS void createRLEImage(const std::vector <cv::Point3i> &runs, OutputArray res,
                                           Size size = Size(0, 0));
...
*/
            CV_EXPORTS void
            morphologyEx(InputArray rlSrc, OutputArray rlDest, int op, InputArray rlKernel,
