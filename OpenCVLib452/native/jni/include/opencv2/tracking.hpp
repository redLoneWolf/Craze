...
*/
        ...
        */
        ...
        create(const TrackerCSRT::Params &parameters = TrackerCSRT::Params());
 ...
 */
    ...
    */
    ...
    create(const TrackerKCF::Params &parameters = TrackerKCF::Params());
    ...
    virtual void
    setFeatureExtractor(FeatureExtractorCallbackFN callback, bool pca_func = false) = 0;
};
