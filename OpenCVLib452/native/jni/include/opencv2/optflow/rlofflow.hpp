...
*/
        ...
        */
        CV_WRAP virtual Ptr<RLOFOpticalFlowParameter>
        ...
        */
         ...
         *    @see getGridStep
         */
        CV_WRAP virtual void setGridStep(Size
        val) = 0;
        ...
        */
         ...
         */
        CV_WRAP virtual InterpolationType
        ...
        */
        CV_WRAP static Ptr<DenseRLOFOpticalFlow>
        create(
...
*/
    class CV_EXPORTS_W SparseRLOFOpticalFlow
    ...
    */
     ...
     *    @param forwardBackwardThreshold see setForwardBackward
    */
    CV_WRAP static Ptr<SparseRLOFOpticalFlow>
    create(
            Ptr<RLOFOpticalFlowParameter>
    rlofParam = Ptr < RLOFOpticalFlowParameter > (),
    float forwardBackwardThreshold = 1.f
...
CV_EXPORTS_W void calcOpticalFlowDenseRLOF(InputArray I0, InputArray I1, InputOutputArray flow,
                                           ...
                                           bool use_post_proc = true, float fgsLambda = 500.0f,
                                           float fgsSigma = 1.5f,
                                           bool use_variational_refinement = false);
...
CV_EXPORTS_W Ptr<SparseOpticalFlow>
