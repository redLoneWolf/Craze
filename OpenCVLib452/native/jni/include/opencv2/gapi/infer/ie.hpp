...
// FIXME: this is probably a shared (reusable) thing
            ...
            struct PortCfg {
                using In = std::array
                        <std::string, std::tuple_size<typename Net::InArgs>::value>;
                using Out = std::array
                        <std::string, std::tuple_size<typename Net::OutArgs>::value>;
            };
            ...
            public:
                Params(const std::string &model,
                       ...
                       const std::string &device)
                        ...
                        , detail::ParamDesc::Kind::Load, false, {}, {}, {}, 1u} {
                };
                ...
                Params(const std::string &model,
                       const std::string &device)
                        : desc{model, {}, device, {}, {}, {},
                               std::tuple_size<typename Net::InArgs>::value  // num_in
                        , std::tuple_size<typename Net::OutArgs>::value // num_out
                        , detail::ParamDesc::Kind::Import, false, {}, {}, {}, 1u} {
                };
                ...
                Params<Net> &
                cfgInputReshape(std::map <std::string, std::vector<std::size_t>> &&reshape_table) {
                    desc.reshape_table = std::move(reshape_table);
                    return *this;
                }

                Params<Net> &cfgInputReshape(
                        const std::map <std::string, std::vector<std::size_t>> &reshape_table) {
                    desc.reshape_table = reshape_table;
                    return *this;
                }

                Params<Net> &
                cfgInputReshape(std::string &&layer_name, std::vector <size_t> &&layer_dims) {
                    desc.reshape_table.emplace(layer_name, layer_dims);
                    return *this;
                }

                Params<Net> &cfgInputReshape(const std::string &layer_name,
            ...
            public:
                Params(const std::string &tag,
                       ...
                       const std::string &device)
                        : desc{model, weights, device, {}, {}, {}, 0u, 0u,
                               detail::ParamDesc::Kind::Load, true, {}, {}, {}, 1u}, m_tag(tag) {
                };
                ...
                Params(const std::string &tag,
                       ...
                       const std::string &device)
                        : desc{model, {}, device, {}, {}, {}, 0u, 0u,
                               detail::ParamDesc::Kind::Import, true, {}, {}, {}, 1u}, m_tag(tag) {
                };
                ...
                Params &cfgInputReshape(const std::string &layer_name,
                                        const std::vector <size_t> &layer_dims) {
                    desc.reshape_table.emplace(layer_name, layer_dims);
                    return *this;
                }
