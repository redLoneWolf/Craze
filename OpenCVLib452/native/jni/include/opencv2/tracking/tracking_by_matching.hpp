...
///
                class CV_EXPORTS ResizedImageDescriptor
            ...
            cv::resize(mat, descr, descr_size_,
            0, 0, interpolation_);
        }
...
///
class CV_EXPORTS CosDistance

: public IDescriptorDistance {
public:
...
///
class CV_EXPORTS MatchTemplateDistance
...
///
CV_EXPORTS cv::Ptr<ITrackerByMatching>

createTrackerByMatching(const TrackerParams &params = TrackerParams());
