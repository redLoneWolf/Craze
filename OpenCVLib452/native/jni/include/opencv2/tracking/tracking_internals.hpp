 ...
 */
            class CV_EXPORTS TrackerContribFeature
...
sampler.
 */
        class CV_EXPORTS TrackerContribSamplerAlgorithm
        ...
        /** @brief Computes the regions starting from a position in an image.
           ...
           */
        virtual bool sampling(const Mat &image, const Rect &boundingBox, std::vector <Mat> &sample)
        ...
        virtual bool
        samplingImpl(const Mat &image, Rect boundingBox, std::vector <Mat> &sample) = 0;
    };
 ...
 */
    class CV_EXPORTS TrackerStateEstimatorAdaBoosting
    ...
    /** @brief Implementation of the target state for TrackerAdaBoostingTargetState
      */
    class CV_EXPORTS TrackerAdaBoostingTargetState
     ...
     */
    TrackerAdaBoostingTargetState(const Point2f &position, int width, int height, bool foreground,
                                  const Mat &responses);
...
/** @brief Constructor
   ...
   */
TrackerStateEstimatorAdaBoosting(int numClassifer, int initIterations, int nFeatures,
                                 Size patchSize, const Rect &ROI);
 ...
 */
class CV_EXPORTS TrackerStateEstimatorSVM
 ...
 */
class CV_EXPORTS TrackerContribSamplerCSC

: public TrackerContribSamplerAlgorithm
{
public:
enum {
...
/** @brief Constructor
   ...
   */
TrackerContribSamplerCSC(
        const TrackerContribSamplerCSC::Params &parameters = TrackerContribSamplerCSC::Params());
...
std::vector <Mat>
sampleImage(const Mat &img, int x, int y, int w, int h, float inrad, float outrad = 0,
            int maxnum = 1000000);
 ...
 */
class CV_EXPORTS TrackerSamplerCS
 ...
 */
class CV_EXPORTS TrackerSamplerPF
 ...
 */
class CV_EXPORTS TrackerFeatureFeature2d

: public TrackerContribFeature
{
public:
 ...
 */
TrackerFeatureFeature2d( String
detectorType,
 ...
 */
class CV_EXPORTS TrackerFeatureHOG
 ...
 */
class CV_EXPORTS TrackerContribFeatureHAAR
...
/** @brief Constructor
   ...
   */
TrackerContribFeatureHAAR(
        const TrackerContribFeatureHAAR::Params &parameters = TrackerContribFeatureHAAR::Params());
...
/** @brief Compute the features only for the selected indices in the images collection
   ...
   */
bool
extractSelected(const std::vector<int> selFeatures, const std::vector <Mat> &images, Mat &response);
 ...
 */
class CV_EXPORTS TrackerFeatureLBP
