...
*/
        ...
        */
        CV_WRAP static Ptr<QualityPSNR>
        create( InputArray
        ref,
        double maxPixelValue = QualityPSNR::MAX_PIXEL_VALUE_DEFAULT
        ) {
        return Ptr <QualityPSNR>(new

        QualityPSNR(QualityMSE::create(ref), maxPixelValue
    ...
    */
    ...
    _qualityMSE->
    getQualityMap(_qualityMap);  // copy from internal obj to this obj
    return
    _mse_to_psnr(
            result
    , _maxPixelValue
...
*/
CV_WRAP static cv::Scalar
compute( InputArray
ref,
InputArray cmp, OutputArray
qualityMap,
double maxPixelValue = QualityPSNR::MAX_PIXEL_VALUE_DEFAULT
)
{
...
static cv::Scalar _mse_to_psnr(cv::Scalar
mse,
