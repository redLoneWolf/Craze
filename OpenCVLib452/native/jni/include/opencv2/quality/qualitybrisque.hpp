...
*/
        ...
        */
        CV_WRAP static Ptr<QualityBRISQUE>

        create(const cv::String &model_file_path, const cv::String &range_file_path);
        ...
        */
        ...
        create(const cv::Ptr<cv::ml::SVM> &model, const cv::Mat &range);
        ...
        */
        CV_WRAP static void computeFeatures(InputArray
        img,
