 ...
 */
        ...
        inline QuantizedPyramid::Candidate::Candidate(int x, int y, int label, float _score) : f(x,
                                                                                                 y,
                                                                                                 label),
                                                                                               score(_score) {}
 ...
 */
        class CV_EXPORTS_W ColorGradient
        ...
        CV_WRAP static Ptr<ColorGradient>

        create(float weak_threshold, size_t num_features, float strong_threshold);
 ...
 */
    class CV_EXPORTS_W DepthNormal
    ...
    CV_WRAP static Ptr<DepthNormal>

    create(int distance_threshold, int difference_threshold,
 ...
 */
CV_EXPORTS_W void colormap(const Mat &quantized, CV_OUT Mat &
 ...
 */
CV_EXPORTS_W void
drawFeatures(InputOutputArray img, const std::vector <Template> &templates, const Point2i &tl,
             int size = 10);
 ...
 */
CV_EXPORTS_W Ptr<linemod::Detector>
