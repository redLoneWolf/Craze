...
//javadoc:getTextSize(text, fontFace, fontScale, thickness, baseLine)
    ...
    public static void rectangle(Mat rgb, Rect2d found, Scalar scalar, int i) {
        rectangle(rgb, new Rect((int) found.x, (int) found.y, (int) found.width, (int) found.height), scalar, i);
    }
}
